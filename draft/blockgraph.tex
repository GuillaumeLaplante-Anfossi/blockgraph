...
\begin{proof}
  Let~$H$ be the Hasse diagram of~${\preccurlyeq}/{\equiv}$.
  By definition, its nodes partition the vertex set~$\vertexSet$.
  We now prove that~$H$ is a directed tree by showing that its underlying undirected graph is connected and acyclic.
  \vincent{todo}
\end{proof}
