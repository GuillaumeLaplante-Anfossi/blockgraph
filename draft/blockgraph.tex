...
\begin{proof}
  This follows from \cref{prop:nodeSplitting,thm:spinePoset}.
\end{proof}
...
\]
whenever $c_i=d_j'$, and units $id_x \in \dioperad(x;x)$ which satisfy appropriate unity, equivariance and associativity axioms, see \cite[Definition 11.18]{YauJohnson15}. 
\end{definition}
