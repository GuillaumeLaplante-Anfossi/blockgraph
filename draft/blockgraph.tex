...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm, label distance=-3pt]  
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm] 
    ...
    \draw[->] (78)--(256) node[midway, left] {\scriptsize \red \textit{adefghijk}}; 
    \draw[->] (3)--(256) node[midway, right] {\scriptsize \red \textit{bc}}; 
    \draw[->] (i)--(78) node[midway, left] {\scriptsize \red \textit{i}}; 
    \draw[->] (adefghjk)--(78) node[midway, right] {\scriptsize \red \textit{adefghjk}};
    ...
    \draw[->] (256)--(bc') node[midway, left] {\scriptsize \red \textit{bc}};
    \draw[->] (256)--(hi) node[midway, right] {\scriptsize \red \textit{hi}};
  \end{tikzpicture}
