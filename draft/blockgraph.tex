...
\begin{definition}
  ...
  For two preorders~$R, R'$ on~$\vertexSet$, we say that~$R$ \defn{extends}~$R'$ when $R \supseteq R'$ as subsets of~$\vertexSet \times \vertexSet$. %, \ie $u \, R' \, v$ implies $u \, R \, v$ for any~$u,v \in \vertexSet$.
\end{definition}
