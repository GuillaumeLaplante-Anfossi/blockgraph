...
\node (1) at (-4, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$1$};
\node (4) at (-4, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$4$};
\node (5) at (-2, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$\up[5]$};
\node (7) at (-4, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$\down[7]$};
\node (8) at (0, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$8$};
\node (9) at (2, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$\up[9]$};
\node (6) at (2, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$6$};
\node (2) at (0, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$\updown[2]$};
\node (3) at (2, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$3$};

\node (f) at (0, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$f$};
\node (d) at (-3, -20) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$d$};
\node (a) at (-5, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$a$};
\node (e) at (-5, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$e$};
\node (i) at (-5, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$i$};
\node (h) at (-3, -22) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$h$};
\node (j) at (1, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$j$};
\node (k) at (3, -23) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$k$};
\node (g) at (3, -21) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$g$};
\node (b) at (1, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$b$};
\node (c) at (3, -19) [circle,draw=none,minimum size=4mm,inner sep=0.1mm]{$c$};
