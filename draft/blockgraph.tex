...
\begin{definition}
  ...
  \vincent{I changed block to chunk...}
\end{definition}
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm] 
    ...
    \node (3) at (1, -2) {$\blue 3$};
    %
    \draw[->] (256)--(14) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (256)--(9) node[midway, right] {\red \textit{fgjk}}; 
    \draw[->] (78)--(256) node[midway, left] {\red \textit{adefghijk}}; 
    \draw[->] (3)--(256) node[midway, right] {\red \textit{bc}}; 
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm]  
    ...
    \node (9) at (1, 2.5) {$\blue \up[9]$};
    %
    \draw[->] (8)--(7) node[midway, left] {\red \textit{adefghjk}}; 
    \draw[->] (7)--(2) node[midway, left] {\red \textit{adefghijk}}; 
    \draw[->] (3)--(2) node[midway, right] {\red \textit{bc}}; 
    \draw[->] (2)--(5) node[midway, left] {\red \textit{adefghijk}}; 
    \draw[->] (5)--(1) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (1)--(4) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (5)--(6) node[midway, right] {\red \textit{fgjk}}; 
    \draw[->] (6)--(9) node[midway, right] {\red \textit{fgjk}}; 
  \end{tikzpicture}
  }
...
\begin{figure}[h!]
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm] 
    ...
    \draw[->] (78)--(256) node[midway, left] {\red \textit{adefghijk}}; 
    \draw[->] (3)--(256) node[midway, right] {\red \textit{bc}}; 
    \draw[->] (i)--(78) node[midway, left] {\red \textit{i}}; 
    \draw[->] (adefghjk)--(78) node[midway, right] {\red \textit{adefghjk}};
    \draw[->] (bc)--(3) node[midway, right] {\red \textit{bc}}; 
    \draw[->] (9)--(k) node[midway, right] {\red \textit{k}}; 
    \draw[->] (9)--(fgj) node[midway, left] {\red \textit{fgj}};
    \draw[->] (14)--(ade) node[midway, left] {\red \textit{ade}};
    \draw[->] (256)--(bc') node[midway, left] {\red \textit{bc}};
    \draw[->] (256)--(hi) node[midway, right] {\red \textit{hi}};
  \end{tikzpicture}
  ...
  \begin{tikzpicture}[circle, draw=none, minimum size=4mm, inner sep=0.1mm]  
    ...
    \draw[->] (7)--(2) node[midway, left] {\red \textit{adefghijk}}; 
    \draw[->] (3)--(2) node[midway, right] {\red \textit{bc}}; 
    \draw[->] (2)--(5) node[midway, right] {\red \textit{adefghijk}}; 
    \draw[->] (5)--(1) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (1)--(4) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (5)--(6) node[midway, right] {\red \textit{fgjk}}; 
    \draw[->] (6)--(9) node[midway, right] {\red \textit{fgjk}}; 
    \draw[->] (4)--(ade) node[midway, left] {\red \textit{ade}}; 
    \draw[->] (9)--(fgj) node[midway, left] {\red \textit{fgj}}; 
    \draw[->] (9)--(k) node[midway, right] {\red \textit{k}}; 
    \draw[->] (adefghjk)--(8) node[midway, left] {\red \textit{adefghjk}}; 
    \draw[->] (i)--(7) node[midway, right] {\red \textit{i}}; 
    \draw[->] (bc)--(3) node[midway, right] {\red \textit{bc}};
    \draw[->] (2)--(bc') node[midway, left] {\red \textit{bc}};
    \draw[->] (5)--(hi) node[midway, right] {\red \textit{hi}};
  \end{tikzpicture}
  }
...
\begin{figure}[h!]
  ...
  \caption{Two pairs of refining spines on the block graphs of \cref{fig:refinementDecoratedGraphs}.}
  \label{fig:refinementSpines}
\end{figure} 
\vincent{TODO: \cref{fig:refinementSpines} is not done yet...}
...
The key property of~$\surjectionSpines(\spine)$ is given in \cref{prop:alternativeDescriptionRefinementSpines}, and should be considered as the definition of~$\surjectionSpines(\spine)$.
However, proving this property requires the following direct description of~$\surjectionSpines(\spine)$, which uses the labeling~$\labeling$ of the nodes and arcs of the spines described in \cref{def:labeledSpine}.
...
\begin{proof}
  Observe first that 
  \vincent{need to say explicitly that~$S$ extends~$S'$...}
  \begin{itemize}
  ...
  \end{itemize}
  It follows that~$\surjectionSpines(\spine)$ is indeed a minimal spine on~$\decoratedGraph'$ extended by~$\spine$.
  Moreover, the spines on~$\decoratedGraph'$ extended by~$\spine$ form an upper ideal of the spine poset~$\spinePoset[\decoratedGraph']$.
  We thus need to show that it is the only minimal spine on~$\decoratedGraph'$ extended by~$\spine$.
  \vincent{todo}
\end{proof}
