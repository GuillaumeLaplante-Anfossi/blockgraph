...
The following definition describes the natural surjection from the spines on~$\decoratedGraph$ to the spines on~$\decoratedGraph'$ when $\decoratedGraph$ refines~$\decoratedGraph'$.
...
%  Let~$\decoratedGraph$ and~$\decoratedGraph'$ be two decorated block graphs such that~$\decoratedGraph$ refines~$\b{G'}$.
...
\begin{proof}
  ...
  Moreover, the spines of~$\decoratedGraph'$ extended by~$\spine$ form an upper ideal of the spine poset~$\spinePoset[\decoratedGraph']$.
