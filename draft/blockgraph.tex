...
\begin{proof}
  ...
  We claim that this forms a spine on the maple tree $\Maple_B$ which is obtained from $\Maple$ by contracting all the edges which are adjacent to a vertex not in~$B$. 
  TBC
