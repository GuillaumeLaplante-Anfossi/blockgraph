...
% \]
% on basis elements by sending the pairs $(\Maple,B)$ and $(\Maple',B')$ to the pair $(\Maple\cup \Maple',B\cup B')$.
% \end{definition}

% \begin{proposition}
%   The $C$-colored $(\mathbb{S},\mathbb{S})$-module $\dioperad_{\decoratedMaple}$ endowed with the above partial composition maps forms a dioperad.
% \end{proposition}
